...
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports cin]

set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum]
