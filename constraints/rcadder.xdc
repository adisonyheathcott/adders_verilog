...
create_clock -name VCLK -period 12.0 -waveform {0 6}

set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[0]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[1]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[2]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[3]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[4]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[5]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[6]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports a[7]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[0]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[1]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[2]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[3]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[4]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[5]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[6]]
set_input_delay 0.0 -clock [get_clocks VCLK] [get_ports b[7]]

set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[0]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[1]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[2]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[3]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[4]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[5]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[6]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports sum[7]]
set_output_delay 0.0 -clock [get_clocks VCLK] [get_ports cout]
...
## LEDs
# set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { sum }]; #IO_L24N_T3_35 Sch=led[4]
